          ...
          <div ref={scrollRef} className="flex gap-6 overflow-x-auto snap-x snap-mandatory pb-4 no-scrollbar">
            {filteredProducts.map((product, index) => (
              <motion.div
                ...
                className="group cursor-pointer shrink-0 w-[280px] snap-start flex flex-col"
              ...
              >
                ...
                <div className="flex flex-col gap-0.5 mb-2">
                  ...
                  <p className="text-xs text-[#5b4f4d] line-clamp-2">{product.description}</p>
                ...
                <button
                  ...
                  className="w-full mt-auto bg-[#2b2724] text-white py-2.5 rounded-sm flex items-center justify-center gap-2 font-['Syne',_sans-serif] font-semibold disabled:opacity-50"
                >
