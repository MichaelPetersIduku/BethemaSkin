      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            <div className="font-['Syne',_sans-serif] font-bold tracking-wider">BETHEMA SKIN</div>
            <p className="text-white/70 text-sm">Premium skincare formulated with your skin's needs in mind.</p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="font-['Syne',_sans-serif] font-semibold text-sm tracking-wide mb-4">QUICK LINKS</h3>
          ...
          {/* Support */}
          <div>
            <h3 className="font-['Syne',_sans-serif] font-semibold text-sm tracking-wide mb-4">SUPPORT</h3>
            <ul className="space-y-2 text-sm text-white/70">
              <li>
          ...
          {/* Social */}
          <div>
            <h3 className="font-['Syne',_sans-serif] font-semibold text-sm tracking-wide mb-4">FOLLOW US</h3>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-center text-sm text-white/50">
          <p>&copy; 2026 Bethema Skin. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
